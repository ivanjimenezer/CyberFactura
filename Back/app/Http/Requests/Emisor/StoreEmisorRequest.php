...
class StoreEmisorRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'key' => 'required|extensions:key|max:800', // Example validation for .key files
            'csd' => 'required|extensions:cer|max:800', // Example validation for .csd files/
    ...
    public function messages(): array
    {
        return [
            ...
            'csd.required' => 'El certificado es obligatorio',

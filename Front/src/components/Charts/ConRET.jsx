...
const RetencionSalesHistogram = ({ retencionSales }) => {
  ...
  return (
    <div className="chartplot">
      <h2 className='chartTitle'>Productos más vendidos con retenciones</h2>
      <div>
        {/* Canvas element for the chart */}
        <canvas className='chart-histogram' ref={chartContainer}/>
      </div>
    </div>
  );
};

export default RetencionSalesHistogram;
